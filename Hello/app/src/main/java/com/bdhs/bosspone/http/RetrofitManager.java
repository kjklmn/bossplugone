...
import com.bdhs.bosspone.application.MainApplication;
import com.bdhs.bosspone.config.DebugConfig;
import com.bdhs.bosspone.presenter.shopinfo.ShopInfoRequest;
import com.bdhs.bosspone.presenter.shopinfo.ShopinfoResponse;
import com.bdhs.bosspone.utils.StringUtils;
...
//                                .addNetworkInterceptor(new StethoInterceptor())//调试使用
    ...
    public Observable<ShopinfoResponse> getShopInfo(ShopInfoRequest shopInfoRequest) {
        return mNetworkService.getShopInfo(shopInfoRequest.sign,shopInfoRequest.shop_id,shopInfoRequest.b_box,shopInfoRequest.v);
    }
